...
export const Footer = ({
  ...
  const footerBtn1_class = 'opacity-0 group-hover:opacity-100 transition absolute top-3 right-3 text-muted-foreground hover:text-blue-600'
  const footerBtn2_class = 'cursor-not-allowed opacity-75'
  const footerStar1_class = 'h-4 w-4'
  const footerStar2_class = 'fill-blue-600 text-blue-600'
